...
class BaseAgu():
    ...
    def init_imporve_lesion_net(self):
        ...
        # 加载预训练权重
        ckpt = torch.load('/data1/wangjingtao/workplace/python/pycharm_remote/meta-learning-segmentation/model/gen_net/results/result_20240416/rips/my_gen/2024-04-24-15-53-51/gen_lesion_256.pth')
