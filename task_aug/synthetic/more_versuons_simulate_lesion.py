...
class SimulateLesions():
    ...
    def _init_dir(self):
        ...
        self.fail_image_dir = os.path.join(self.args.project_path,"result/fail_image")
        ...
        self.label_dict = self.read_labelTxt(self.args.label_text_path)
