...
class SyntheticHeShiRP():
    ...
    def init_imporve_lesion_net(self):
        ...
        # 加载预训练权重
        ckpt = torch.load('/data1/wangjingtao/workplace/python/pycharm_remote/meta-learning-segmentation/model/gen_net/results/result_20240416/heshi/my_gen/2024-04-26-08-53-36/gen_lesion_256.pth')
    ...
    def choose_similar_ssim(self, img1_path):
        ...
        # 已经计算好，直接从本地加载结果
        with open('/data1/wangjingtao/workplace/python/data/ssim/ssim_heshi.json', 'r') as f:
    ...
    def forward(self):
        for i, img1_path in enumerate(self.img_files):
            ...
            ssim_similar_ls = task_ut.choose_similar_ssim(img1_path,'/data1/wangjingtao/workplace/python/data/ssim/ssim_heshi.json')
            
            for k, img2_name in enumerate(ssim_similar_ls):
                img2_path = os.path.join('/data1/wangjingtao/workplace/python/data/rp_data/heshi/normal/normal', img2_name)
