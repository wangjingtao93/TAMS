...
def creat_multi_tasks():
    store_path = os.path.join(relative_path, 'data/rips_fundus_rp/real_data/multi_tasks')
    os.mkdir(store_path)

    new_df = pd.read_csv(os.path.join(relative_path,'data/rips_fundus_rp/real_data/all_data.csv'))
...
# 测试 S和Q是否有重复的eye
def test_s_q():
    df_s = pd.read_csv(os.path.join(relative_path,'data/rips_fundus_rp/real_data/multi_tasks/t_0_s.csv'))
    df_q = pd.read_csv(os.path.join(relative_path,'data/rips_fundus_rp/real_data/multi_tasks/t_0_s.csv'))
