...
def train(args):
    ...
    if args.datatype == 'bv1000_ocv_cnv':
        ...
        # 加载RIPS数据集 
        all_data_path = os.path.join(object_path, 'data/rips_fundus_rp/real_data/all_data.csv')
    ...
    # 定义优化器和损失函数
    # fundus 要使用lr=0.001, OCT lr=0.0002
...
def cfg():
    ...
    parse.add_argument('--datatype', type=str, choices=['bv1000_oct_cnv', 'rips', 'heshi'],default='heshi', help='')
